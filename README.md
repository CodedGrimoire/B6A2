...
A backend API for a vehicle rental management system that handles vehicles, customers, bookings, and authentication with role-based access control. The system provides RESTful endpoints for managing vehicle inventory, user accounts, and booking operations with automatic price calculation and availability tracking.
...
### Example Endpoints
- **Sign Up**: `POST https://your-api-domain.com/api/v1/auth/signup`
- **Sign In**: `POST https://your-api-domain.com/api/v1/auth/signin`
- **Get Vehicles**: `GET https://your-api-domain.com/api/v1/vehicles`
- **Get Bookings**: `GET https://your-api-domain.com/api/v1/bookings`

> **Note**: Replace `your-api-domain.com` with your actual deployed API domain.
